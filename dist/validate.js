...
import { parseYamlValue, parseYamlNested, parseEnvOverrides, parseModelsByCategory, DEFAULT_ENV_PREFIX, } from './utils/config.js';
 ...
 */
function validateModelConfiguration(configContent) {
    const errors = [];
    // Check default model
