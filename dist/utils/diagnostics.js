...
(function (ErrorCategory) {
    ...
    ErrorCategory["EXPECTED"] = "expected";
 ...
 * ```
 */
export function logSilentError(error, context, category = ErrorCategory.UNKNOWN) {
 ...
 * ```
 */
export function getSilentErrorSummary() {
    const byCategory = {
 ...
 */
export function getAllSilentErrors() {
 ...
 */
export function clearSilentErrors() {
 ...
 */
export function getSilentErrorCount(category) {
 ...
 */
export function hasUnknownErrors() {
