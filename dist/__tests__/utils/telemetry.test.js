...
const { initTelemetry, shutdownTelemetry, isTelemetryEnabled, getTelemetryConfig, getTracer, getMeter, getCurrentTraceId, getCurrentSpanId, startTaskSpan, startGitHubSpan, startClaudeSpan, endSpanSuccess, endSpanError, withSpan, withSpanAsync, recordTaskCompletion, recordClaudeInvocation, recordGitHubOperation, checkTelemetryHealth, getPrometheusEndpoint, } = await import('../../utils/telemetry.js');
describe('telemetry module', () => {
    ...
    describe('withSpanAsync', () => {
        ...
        it('should handle async errors', async () => {
            await expect(withSpanAsync('failing-async', async () => {
