...
const { generateSessionId, getLocksDir, getLockFilePath, ensureLocksDir, readTaskLock, isLockStale, acquireTaskLock, releaseTaskLock, forceReleaseTaskLock, updateLockHeartbeat, listTaskLocks, findStaleLocks, cleanupStaleLocks, isIssueLocked, isLockedByOther, releaseAllSessionLocks, DEFAULT_LOCK_TIMEOUT_MINUTES, } = await import('../../utils/locks.js');
describe('locks utilities', () => {
    ...
    describe('acquireTaskLock', () => {
        ...
        it('should refresh lock if same session owns it', () => {
            ...
            expect(new Date(result.lock.last_heartbeat).getTime()).toBeGreaterThan(new Date('2026-01-15T10:00:00Z').getTime());
        });
