...
let writeFileSyncImpl = null;
let renameSyncImpl = null;
let unlinkSyncImpl = null;
let existsSyncImpl = null;
...
describe('fileOps utilities', () => {
    ...
    describe('atomicWriteFile', () => {
        ...
        it('should use writeFileSync for temp file and renameSync for atomic replace', () => {
            ...
            expect(fsMock.writeFileSync).toHaveBeenCalledWith(expect.stringMatching(/\/project\/\.chadgi\/\.tmp\.\d+\.\d+\.[a-z0-9]+$/), '{"key": "value"}', 'utf-8');
            // Should have renamed temp to target
            expect(fsMock.renameSync).toHaveBeenCalledWith(expect.stringMatching(/\/project\/\.chadgi\/\.tmp\.\d+\.\d+\.[a-z0-9]+$/), '/project/.chadgi/config.json');
        });
        ...
        it('should clean up temp file on rename error', () => {
            ...
            writeFileSyncImpl = (path, content) => {
                vol.writeFileSync(path, content);
            };
            renameSyncImpl = () => {
    ...
    describe('atomicWriteJson', () => {
        ...
        it('should handle complex nested objects', () => {
            ...
            atomicWriteJson('/project/.chadgi/progress.json', data);
            const result = JSON.parse(vol.readFileSync('/project/.chadgi/progress.json', 'utf-8'));
        ...
        it('should handle arrays', () => {
            ...
            const result = JSON.parse(vol.readFileSync('/project/.chadgi/tasks.json', 'utf-8'));
            expect(result).toEqual(data);
        });
    ...
    describe('safeWriteFile', () => {
        ...
        it('should fail after max retries exceeded', async () => {
            ...
            await expect(safeWriteFile('/project/.chadgi/test.txt', 'content', { maxRetries: 2, retryDelayMs: 10 })).rejects.toThrow('Resource busy');
    ...
    describe('safeParseJson', () => {
        ...
        it('should include file path in error message when provided', () => {
            ...
            safeParseJson(content, { filePath: '/path/to/config.json' });
        ...
        it('should show debug details when verbose mode is enabled', () => {
            ...
            safeParseJson(content, { filePath: '/test.json' });
        ...
        it('should parse primitive JSON values', () => {
            const stringResult = safeParseJson('"hello"');
            const numberResult = safeParseJson('42');
            const boolResult = safeParseJson('true');
