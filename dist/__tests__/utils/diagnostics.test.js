...
const { ErrorCategory, logSilentError, getSilentErrorSummary, getAllSilentErrors, clearSilentErrors, getSilentErrorCount, hasUnknownErrors, formatErrorSummary, } = await import('../../utils/diagnostics.js');
