...
function printInsights(analysis, _chadgiDir) {
 ...
 */
async function insightsHandler(ctx) {
 ...
 */
export const insightsMiddleware = withCommand([withDirectory, withDirectoryValidation], insightsHandler);
//# sourceMappingURL=insights-middleware.js.map