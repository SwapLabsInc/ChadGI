...
import { withCommand, withDirectory, withDirectoryValidation, 
 ...
 */
export const historyMiddleware = withCommand([withDirectory, withDirectoryValidation], historyHandler);
