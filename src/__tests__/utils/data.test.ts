...
import type { SessionStats, TaskMetrics, MetricsData, PauseLockData, ApprovalLockData, ProgressData } from '../../types/index.js';
...
describe('data utilities', () => {
  ...
  describe('getMostRecentSession', () => {
    ...
    it('should handle single session', () => {
      ...
      const singleSession: SessionStats = {
  ...
  describe('loadJsonFile', () => {
    it('should load and parse JSON file', () => {
      ...
      const result = loadJsonFile<{ key: string }>('/test.json');
