 ...
 */
export interface DirectoryContext<T extends BaseCommandOptions = BaseCommandOptions>
  extends CoreContext<T> {
 ...
 */
export interface ConfigContext<T extends BaseCommandOptions = BaseCommandOptions>
  extends DirectoryContext<T> {
 ...
 */
export interface TimedContext<T extends BaseCommandOptions = BaseCommandOptions>
  extends CoreContext<T> {
 ...
 */
export interface CommandContext<T extends BaseCommandOptions = BaseCommandOptions>
  extends ConfigContext<T>,
    TimedContext<T> {}
 ...
 */
export type PartialContext<T extends BaseCommandOptions = BaseCommandOptions> = Partial<
  CommandContext<T>
> &
  CoreContext<T>;
 ...
 */
export function createCoreContext<T extends BaseCommandOptions = BaseCommandOptions>(
  createOptions: CreateContextOptions<T> = {}
): CoreContext<T> {
  return {
    options: (createOptions.options || {}) as T,
 ...
 */
export function hasDirectoryContext<T extends BaseCommandOptions>(
  ctx: CoreContext<T>
): ctx is DirectoryContext<T> {
 ...
 */
export function hasConfigContext<T extends BaseCommandOptions>(
  ctx: CoreContext<T>
): ctx is ConfigContext<T> {
  return (
    hasDirectoryContext(ctx) &&
 ...
 */
export function hasTimingContext<T extends BaseCommandOptions>(
  ctx: CoreContext<T>
): ctx is TimedContext<T> {
 ...
 */
export function hasFullContext<T extends BaseCommandOptions>(
  ctx: CoreContext<T>
): ctx is CommandContext<T> {
